...
export const shrineData: Shrine[] = [
  {
    ...
    significance: "Invoke the strength to begin. As the sun rises, so too does your inner awareness. Let this first step be a promise to yourself to walk with presence and purpose.",
    latitude: 12.2353,
    longitude: 79.0847,
    color: "#FFA500",
    emoji: "🌞",
  ...
  },
  {
    ...
    element: "Fire",
    direction: "Southeast",
    description: "Feel the heat of transformation at Agni Lingam. Located in the direction of fire, this shrine pulses with an intensity that mirrors the burning of karmic impurities. The atmosphere here is charged, often filled with the smoke of camphor and the fervent prayers of devotees. It is a place where the old self is offered to the flames, making way for purification and renewal.",
    significance: "Fire does not destroy; it transforms. Offer your doubts, fears, and burdens to the sacred flame here. Allow the heat of devotion to forge a stronger, purer spirit within you.",
    latitude: 12.2253,
    longitude: 79.0897,
    color: "#FF4500",
    emoji: "🔥",
  ...
  },
  {
    ...
    direction: "South",
    description: "Stand before the guardian of the South, Yama Lingam. Often misunderstood as fearful, Yama represents the inevitable law of dharma and the cycle of time. The energy here is solemn and grounding, urging pilgrims to reflect on the impermanence of physical life. It is said that sincere prayer here grants freedom from the fear of death and guides one towards a righteous life.",
    significance: "Contemplate your mortality not with fear, but as a teacher. Realize that every moment is precious. Let go of petty grievances and align your actions with your highest truth.",
    latitude: 12.2153,
    longitude: 79.0847,
    color: "#8B0000",
    emoji: "⚖️",
  ...
  },
  {
    ...
    direction: "Southwest",
    description: "Enter the quiet embrace of Niruthi Lingam. Tucked away in the shadows of the path, this shrine is ruled by the guardian of the Southwest, protecting pilgrims from negative influences. The atmosphere is dense and protective, often inviting a slower pace. It is a place to ground yourself deeply, connecting with the stability of the earth beneath your feet.",
    significance: "Seek stability in chaos. When the mind wavers, return to the breath and the body. Here, ask for protection not just from external harm, but from your own inner negativity.",
    latitude: 12.2153,
    longitude: 79.0747,
    color: "#654321",
    emoji: "🪨",
  ...
  },
  {
    ...
    element: "Water",
    direction: "West",
    description: "Flow into the serenity of Varuna Lingam. Dedicated to the Lord of Waters, this shrine offers a cooling respite on the long journey. Like a river that carves through rock with persistence and grace, this space invites emotional cleansing. The energy here is fluid and healing, washing away the rigidity of the ego and soothing the weary traveler.",
    significance: "Be like water—soft yet yielding, humble yet powerful. Allow your emotions to flow without judgment. Wash away the dust of the road and the dust of the mind.",
    latitude: 12.2153,
    longitude: 79.0647,
    color: "#0066CC",
    emoji: "🌧️",
  ...
  },
  {
    ...
    element: "Air",
    direction: "Northwest",
    description: "Breathe in the vastness at Vayu Lingam. Here, the air element reigns supreme. Often breezy and open, this shrine represents the life force (Prana) that sustains all beings. It is a place of movement and lightness, where the wind carries the prayers of thousands towards the peak of Arunachala. The sensation here is one of unburdening and expansion.",
    significance: "Connect with your breath, the bridge between body and spirit. Inhale the sacred energy of the mountain; exhale all that no longer serves you. Feel the freedom of the wind.",
    latitude: 12.2253,
    longitude: 79.0647,
    color: "#4682B4",
    emoji: "🌬️",
  ...
  },
  {
    ...
    significance: "True abundance is a heart full of gratitude. Reflect on the gifts you have been given—this body, this breath, this moment. Prosperity flows to those who appreciate what is.",
    latitude: 12.2353,
    longitude: 79.0647,
    color: "#228B22",
    emoji: "🌱",
  ...
  },
  {
    ...
    significance: "The path ends where it began, but you are not the same. In the silence of Eesanya, surrender your final identity. You are the space in which the universe dances. Om Namah Shivaya.",
    latitude: 12.2353,
    longitude: 79.0747,
    color: "#4B0082",
    emoji: "🌙",
